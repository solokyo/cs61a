...
class Person:
    ...
    def __init__(self, name):
        self.name = name
        self.mem = 'I squirreled it away before it could catch on fire.' 
        "*** YOUR CODE HERE ***"
...
class SmartFridge:
    ...
    def add_item(self, k, v):
        "*** YOUR CODE HERE ***"
        self.d[k] += v
        return ("I now have {} {}".format(self.d[k], k))

    def use_item(self, k, v):
        "*** YOUR CODE HERE ***"
        if(self.d[k] > v):
            self.d[k] -= v
            return ("I have {} {} left".format(self.d[k], k))
        else:
            self.d[k] = 0
            return ("Oh no, we need more {}!".format(k))
...
class Round:
    ...
    def is_complete(self):
        ...
        # return self.starter == self.next_player
        return self.step != 0 and self.step % 4 == 0
